...
urlpatterns = [
    ...
    path('api/del_promos/', pviews.promos_delete),
    path('api/upd_promos/', pviews.promos_update),
    path('api/create_promos/', pviews.promos_create),
    path('api/get_accounts/', pviews.accounts),
    path('api/del_accounts/', pviews.accounts_delete),
    path('api/upd_accounts/', pviews.accounts_update),
    path('api/create_accounts/', pviews.accounts_create),
    ...
    path('api/get_estimate_pdf/', pviews.get_estimate_pdf),
    path('api/upload_catalog_excel/', pviews.upload_catalog_excel),
    path('api/clear_catalog/', pviews.clear_catalog),
